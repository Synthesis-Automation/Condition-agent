...
MANUAL_FAMILY_PATTERNS: Dict[str, Tuple[str, str]] = {
    ...
    r"\b13965-03-2\b": ("metal_catalyst", "pd_phosphine_complexes"),
    r"\b14221-01-3\b": ("metal_catalyst", "pd_phosphine_complexes"),
    r"\b7681-65-4\b": ("metal_catalyst", "cu_salts"),
    r"\b3375-31-3\b": ("metal_catalyst", "pd_ii_salts"),
    r"\b51364-51-3\b": ("metal_catalyst", "pd_zero_sources"),
    r"\b12124-67-5\b": ("metal_catalyst", "pd_ii_salts"),
