...
def _nitrogen_product(anchor_context: str, nitrogen: ReactionSiteReference, bond: str, style: str) -> str:
    ...
    retained = [n_substituent(token) for token in nitrogen.details.get("contexts") or []]
...
__all__ = ["load_product_context_precedence", "load_reaction_rendering", "render_context_connection", "render_heteroatom_product", "render_reactant_label", "render_reaction_label"]
