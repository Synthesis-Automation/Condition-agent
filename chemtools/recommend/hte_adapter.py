    ...
    **_: Any,
    ...
    extras = {
        "hte": {
            ...
            "plausibility_family": getattr(result, "plausibility_family", None),
            "filtered_implausible_catalyst_rows": getattr(result, "filtered_implausible_catalyst_rows", 0),
            "penalized_implausible_mechanism_rows": getattr(result, "penalized_implausible_mechanism_rows", 0),
            "plausibility_issue_counts": dict(getattr(result, "plausibility_issue_counts", {}) or {}),
