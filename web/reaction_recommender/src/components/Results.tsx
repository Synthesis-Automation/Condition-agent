      ...
      <div className="results-summary">
        ...
        <div className="results-summary-actions">
          ...
          <div className="metric-strip">
            ...
            <div><strong>{result.recommendation_mode === 'experimental_shared_core' ? 'Shared graph search' : displayName(result.retrieval_level ?? 'none')}</strong><span>{result.recommendation_mode === 'experimental_shared_core' ? 'retrieval' : 'fallback level'}</span></div>
          </div>
        </div>
      </div>
