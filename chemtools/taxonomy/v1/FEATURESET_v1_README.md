...
- `reactivity_features.computed.v1.json` — sterics POC v1 spec (ortho substitution counts only)
- `REACTIVITY_STERICS_POC_v1_README.md` — sterics POC v1 notes + usage
- `reactivity_features.computed.v2.json` — sterics v2 spec (ortho substitution + topological bulk → 0–10 steric score)
- `REACTIVITY_STERICS_POC_v2_README.md` — sterics v2 notes + usage
- `reactivity_features.electronics.computed.v1.json` — electronics POC v1 spec (Gasteiger delta charge → 0–10 electron-poor score)
- `REACTIVITY_ELECTRONICS_POC_v1_README.md` — electronics POC v1 notes + usage
