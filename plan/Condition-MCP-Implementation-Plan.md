...
- [ ] Define **ConditionSet** JSON schema (IDs, loadings, units, rationale, citations).

### Phase B — Tools (thin wrappers)
- [ ] Implement `normalize_reaction`, `detect_family`, `featurize_substrates` wrappers.
...
### Phase E — Tests & CI
- [ ] **Contract tests**: JSON schema validation for every tool output.
