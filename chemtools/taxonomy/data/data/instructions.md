...
• → prefer Pd/XPhos
• ML models:
o Each feature is a stable, low-noise, interpretable binary or categorical input
o No entangled SMARTS logic inside the model
...
o Automated labs
o Closed-loop optimization
o Self-learning reaction platforms
...
1. Chemical logic outside SMARTS
1. Composition over nesting
1. Features designed for reasoning, modeling, and automation
