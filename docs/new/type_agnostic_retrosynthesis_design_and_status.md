...
| Precedent-route expansion | Observed two-step POC | Three source-verified patent segments with stock-verified substitutes expand from 3 exact products to 16 L2-context and 33 L1-relaxed products; analogue feasibility remains uncalibrated. |
