...
Architecture:
    ...
    â”œâ”€â”€ Core Operations (stateless, always available)
    â”?  â”œâ”€â”€ smiles - SMILES parsing and normalization
    â”?  â”œâ”€â”€ router - Reaction family detection
    â”?  â”œâ”€â”€ properties - Compound property lookup
    â”?  â”œâ”€â”€ constraints - Constraint validation
    â”?  â””â”€â”€ functional_groups - Functional group detection
    â”?
    â”œâ”€â”€ Data Operations (stateful, lazy-loaded through context)
    â”?  â”œâ”€â”€ precedent - Precedent reaction search
    â”?  â”œâ”€â”€ recommend - HTE-based condition recommendations
    â”?  â””â”€â”€ explain - Explanation generation
    â”?
    â””â”€â”€ Advanced Operations (optional dependencies)
        â”œâ”€â”€ featurizers - Molecular featurization
        â”œâ”€â”€ features - Role-aware features (if available)
        â””â”€â”€ integrations - External integrations (MCP, etc.)
"""
