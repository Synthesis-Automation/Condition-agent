...
✅ **Supports all metal catalysts**: Cu, Pd, Ni, Ir, Rh, Ru, Pt, Au, Ag, Fe, Co, Zn  
✅ **Reactant type detection**: Automatic classification (ArBr, ArNH2, etc.)  
✅ **Statistical ranking**: Success rates, confidence scores, yield statistics  
✅ **Flexible filtering**: By reaction type, catalyst, reactant types, yield  
✅ **Multiple output formats**: Terminal display, JSON, CSV export  
✅ **Batch processing**: Process multiple reactant pairs from file  
...
- HTE database: `data/HTE_db/HTE_0.jsonl` (66,308 experiments)
