...
def flatten_record(record: RecommendationRecord) -> Dict[str, Any]:
    ...
    return {
        ...
        "reaction_display_label_detailed": (record.reaction_label or {}).get("detailed", ""),
...
def convert_file(input_path: str | Path, output_dir: str | Path) -> Dict[str, Any]:
    ...
    report = {
        ...
        "reaction_display_status_counts": dict(sorted(Counter(
            (record.reaction_label or {}).get("status", "unavailable")
