...
SAMPLE_REACTIONS = [
    ...
    # Reductive Amination
    "O=Cc1ccccc1.Nc1ccccc1>>c1ccc(CNc2ccccc2)cc1 (Reductive Amination - Benzaldehyde + aniline, secondary amine)",
    "CC=O.NC>>CCNC (Reductive Amination - Acetaldehyde + methylamine, primary to secondary)",
    "c1ccc(C=O)cc1.NCC>>c1ccc(CNCC)cc1 (Reductive Amination - Benzaldehyde + ethylamine)",
    "O=Cc1ccc(OC)cc1.NC>>COc1ccc(CNC)cc1 (Reductive Amination - p-Anisaldehyde + methylamine)",
    "O=Cc1ccccc1.NCCCC>>c1ccc(CNCCCC)cc1 (Reductive Amination - Benzaldehyde + butylamine)",
    "CC(=O)c1ccccc1.Nc1ccccc1>>c1ccc(NC(C)c2ccccc2)cc1 (Reductive Amination - Acetophenone + aniline, ketone substrate)",
    "CC(=O)C.NC>>CC(C)NC (Reductive Amination - Acetone + methylamine, ketone to sec-amine)",
    "O=C1CCCCC1.Nc1ccccc1>>C1CCC(Nc2ccccc2)CC1 (Reductive Amination - Cyclohexanone + aniline)",
    "O=Cc1ccc([N+](=O)[O-])cc1.Nc1ccccc1>>[O-][N+](=O)c1ccc(CNc2ccccc2)cc1 (Reductive Amination - p-Nitrobenzaldehyde, EWG substrate)",
    "O=Cc1ccc(Cl)cc1.NCCC>>Clc1ccc(CNCCC)cc1 (Reductive Amination - p-Chlorobenzaldehyde + propylamine)",
    "O=Cc1ccncc1.Nc1ccccc1>>c1ccc(NCc2ccncc2)cc1 (Reductive Amination - Pyridine-4-carbaldehyde, heteroaryl aldehyde)",
    "O=Cc1cnccn1.NC>>CNc1cnccn1 (Reductive Amination - Pyrimidine-5-carbaldehyde, diazine substrate)",
    "c1ccc(C=O)cc1.NCC(=O)O>>O=C(O)CNCc1ccccc1 (Reductive Amination - Benzaldehyde + glycine, amino acid)",
    "O=Cc1ccccc1.NC(C)C>>c1ccc(CNC(C)C)cc1 (Reductive Amination - Benzaldehyde + isopropylamine, branched)",
    "CC=O.C1CCNCC1>>CCN1CCCCC1 (Reductive Amination - Acetaldehyde + piperidine, cyclic sec-amine)",
    "c1ccc(C=O)cc1.Nc1ccc(OC)cc1>>COc1ccc(NCc2ccccc2)cc1 (Reductive Amination - Benzaldehyde + p-anisidine, EDG amine)",
    "O=Cc1ccc(C(F)(F)F)cc1.Nc1ccccc1>>FC(F)(F)c1ccc(CNc2ccccc2)cc1 (Reductive Amination - Trifluoromethyl benzaldehyde, EWG)",
    "CC(=O)CC.Nc1ccccc1>>CCC(C)Nc1ccccc1 (Reductive Amination - Butanone + aniline)",
    "O=C1CCCC1.NC>>CC1CCCNC1 (Reductive Amination - Cyclopentanone + methylamine)",
    "O=Cc1c[nH]c2ccccc12.Nc1ccccc1>>c1ccc(NCc2c[nH]c3ccccc23)cc1 (Reductive Amination - Indole-3-carbaldehyde)",
    "O=Cc1coc2ccccc12.NC>>CNc1coc2ccccc12 (Reductive Amination - Benzofuran-2-carbaldehyde)",
    "O=Cc1csc2ccccc12.Nc1ccccc1>>c1ccc(NCc2csc3ccccc23)cc1 (Reductive Amination - Benzothiophene-2-carbaldehyde)",
    "CC(C)C=O.Nc1ccccc1>>CC(C)CNc1ccccc1 (Reductive Amination - Isobutyraldehyde + aniline)",
    "c1ccc(C=O)cc1.NCc1ccccc1>>c1ccc(CNCc2ccccc2)cc1 (Reductive Amination - Benzaldehyde + benzylamine)",
    "O=CCc1ccccc1.Nc1ccccc1>>c1ccc(CCCNc2ccccc2)cc1 (Reductive Amination - Phenylacetaldehyde + aniline)",
    "CCCC=O.NC(C)C(=O)O>>CCCCNC(C)C(=O)O (Reductive Amination - Butyraldehyde + alanine, chiral amino acid)",
    "O=Cc1ccc2ccccc2c1.Nc1ccccc1>>c1ccc(NCc2ccc3ccccc3c2)cc1 (Reductive Amination - 2-Naphthaldehyde + aniline)",
    "CC(=O)c1ccc(OC)cc1.NC>>COc1ccc(C(C)NC)cc1 (Reductive Amination - p-Methoxyacetophenone + methylamine)",
    "O=Cc1ccc(N(C)C)cc1.Nc1ccccc1>>CN(C)c1ccc(CNc2ccccc2)cc1 (Reductive Amination - Dimethylamino benzaldehyde, EDG)",
