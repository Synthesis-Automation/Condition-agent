...
def _default_buckets() -> Dict[str, Set[str]]:
    buckets = {
        ...
        "organoboron": {
            "Ar-B(OH)2", "Ar-Bpin", "Vinyl-B(OH)2", "Vinyl-Bpin",
        },
        "terminal_alkyne": {"Ar-CCH", "R-CCH"},
        "terminal_alkene": {"Ar-CHCH2", "R-CHCH2"},
        "amine": {"Any-NH2", "Any-NHR", "Ar-NH2", "Ar-NHR", "Vinyl-NH2"},
        "alcohol": {"Any-OH", "Ar-OH", "Bn-OH", "Allyl-OH", "Vinyl-OH"},
        "thiol": {"Any-SH", "Ar-SH"},
        "acid": {"Any-CO2H", "Ar-CO2H", "Vinyl-CO2H"},
        "acyl_halide": {"Acyl-Br", "Acyl-Cl", "Any-COCl", "Ar-COCl"},
        "amide": {"Any-CONHR", "Ar-CONHR"},
