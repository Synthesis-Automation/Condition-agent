        ...
        if symbol == "C" and double_oxygens:
            ...
            if group is not None:
                ...
                sites.append(SiteCandidate(
                    ...
                    matched_patterns=("acyl_oxygen_or_halide",),
                    details={"center_family": "Acyl", "reaction_mode": "substitution", "retained_context": context_token, "leaving_or_activatable_group": token, "activation_state": state},
