...
- `chemtools/reagent/reagent_schema/families_registry.json`
...
- **Protocol tooling**: `chemtools/protocol/*`, `scripts/build_unified_drfp_index.py`, `show_protocol_format.py` expect family IDs aligned with precedent datasets.
