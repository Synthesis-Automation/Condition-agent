"""Test the new reaction key-based detection system."""

from chemtools.reaction_key_matcher import detect_reaction_type_from_smiles
...
test_cases = [
    ...
    # Heck (vinyl arylation)
    {
        "name": "Heck",
        "smiles": "Brc1ccccc1.C=Cc1ccccc1>>c1ccc(/C=C/c2ccccc2)cc1",
        "expected": "Heck",
    },
    ...
    # Nitro reduction
    {
        "name": "Reduction_nitro",
        "smiles": "[O-][N+](=O)c1ccccc1>>Nc1ccccc1",
        "expected": "Reduction_nitro",
    },
]

print("=" * 70)
print("Testing Reaction Key-Based Detection System")
print("=" * 70)
...
for case in test_cases:
    ...
    top, all_matches = detect_reaction_type_from_smiles(case["smiles"])
    ...
    if top:
        ...
        print(f"  Matched reacted: {top.matched_reacted}")
        print(f"  Matched formed: {top.matched_formed}")
