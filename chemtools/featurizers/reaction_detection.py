...
_COUPLING_CONFIRMATION_SPECS: Dict[str, CouplingConfirmationSpec] = {
...
def detect_reaction_types(
    ...
    *,
    ...
    confirm_suzuki_products: bool = False,
    ...
    if (confirm_suzuki_products or confirm_coupling_products) and product_smiles is not None:
        ...
        for match in matches:
            if match.reaction_type == "Suzuki_miyaura" and confirm_suzuki_products:
                ...
                if not confirm_coupling_products or match.reaction_type not in _COUPLING_CONFIRMATION_SPECS:
...
def confirm_coupling_product_by_attachment(
    ...
    spec = _COUPLING_CONFIRMATION_SPECS.get(reaction_type)
    if spec is None:
