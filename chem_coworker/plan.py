...
_SMILES_PLACEHOLDER_RE = re.compile(
    ...
    r"|(?:SMILES_)?FROM_G(?:ROUP_)?\d+"   # FROM_G1, FROM_G0, SMILES_FROM_G1, FROM_GROUP_0, …
    r"|PLACEHOLDER_\w+"                   # PLACEHOLDER_HESTERETIN_SMILES, PLACEHOLDER_TARGET, …
    r"|\w+_SMILES"                        # HESTERETIN_SMILES, BENZENE_SMILES, TARGET_SMILES, …
    r")$",
    re.IGNORECASE,
)
