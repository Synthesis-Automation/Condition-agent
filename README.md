...
Deterministic chemistry tools (FastAPI + RDKit-friendly) to support condition recommendation. Focuses on Ullmann Câ€“N first, with simple hooks for more families.
